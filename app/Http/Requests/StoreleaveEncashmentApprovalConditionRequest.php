...
class StoreleaveEncashmentApprovalConditionRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'leave_encashment_approval_rule_id' => 'required|integer|unique:leave_encashment_approval_conditions|exists:leave_encashment_approval_rules,id',
