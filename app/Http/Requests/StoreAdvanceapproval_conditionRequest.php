...
class StoreAdvanceapproval_conditionRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'approval_rule_id' => 'required|integer|unique:advanceapproval_conditions|exists:advance_approval_rules,id',
