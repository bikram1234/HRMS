...
class StoreExpenseapproval_conditionRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'approval_rule_id' => 'required|integer|unique:expenseapproval_conditions|exists:expense_approval_rules,id',
