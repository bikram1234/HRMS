...
class advance_apply  extends Controller
{
    ...
    public function details(){
        ...
        $user = Auth::user();
        // Fetch SalaryAdvance records for the current user
        $Advanceapplication = AdvanceApplication::with('advanceType')->where('user_id', $user->id)->get();

        return view('advance.advance_apply.advanceloan_details', compact('Advanceapplication'));
      ...
      public function show_Advance()
      {
        ...
        // dd($empy_id);
          //dd($advance_type);
          return view('advance.advance_apply.advanceloan_form', compact('advance_type','device'));
      }
