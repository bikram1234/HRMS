...
use App\Models\applied_encashment;
...
class EncashmentApghjprovalController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        if($leaveEncashmentApprovalCondition->approval_type == "Single User"){
            ...
            if($currentUserID == $leaveEncashmentApprovalCondition->user_id){
                $appliedencashments = applied_encashment::all();
                return view('leave.approval.leaveApproval', compact('appliedencashments')); 
            }
