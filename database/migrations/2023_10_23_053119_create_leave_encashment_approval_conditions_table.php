...
return new class extends Migration
{
    ...
    {
        Schema::create('leave_encashment_approval_conditions', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('leave_encashment_approval_rule_id');
            ...
            $table->foreign('leave_encashment_approval_rule_id', 'fk_leave_encashment_approval_rule_id')
            ->references('id')
            ->on('leave_encashment_approval_rules')
            ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('leave_encashment_approval_conditions');
    }
};
