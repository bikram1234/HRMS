...
return new class extends Migration
{
    ...
    {
        Schema::create('expense_approval_conditions', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('approval_rule_id')->references('id')->on('expense_approval_rules')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('expense_approval_conditions');
    }
};
