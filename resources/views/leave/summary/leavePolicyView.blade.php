...
<div class="container mt-5">
    ...
    <div class="form-group">
        <label for="attachment_required">Contract Period:</label>
        <input type="checkbox" id="contract_period" name="contract_period" value="1" {{ $leavePlan->contract_period    ? 'checked' : '' }} disabled>
    </div>  
    <div class="form-group">
    ...
    @else
        <!-- Handle the case when $yearEndProcessing is null or empty -->
        <p>No year-end processing data available.</p>
    @endisset
