...
<div class="container">
        ...
        <tbody>
                @foreach ($formulas as $formula)
                    <tr>
                            ...
                            @endif
                        <td>    
                        <form action="{{ route('encashment_formula.delete', $formula->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
    ...
    <form id="formula-form" method="POST" action="{{ route('encashment_formula.store') }}">
        @csrf
        ...
        <div class="form-group mt-3">
            <input type="hidden" id="condition-id" name="encashment_condition_id" value="{{ $encashmentApprovalConditionId }}" >
        </div>
