...
<div class="page-wrapper">      
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="{{route('approval.create')}}" class="btn add-btn" data-toggle="modal" data-target="#add_new_approval"><i class="fa fa-plus"></i>Add New Approval</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="word-container mb-4">
                            <span class="word active"><a href="">Leave</a></span>
                            ...
                            <div class="container table-responsive">  
                                ...
                                <td class="text-right"> 
                                    <div class="d-flex align-items-center">
                                        <a href="{{ route('approval.show', ['approvalRule' => $approval->id])}}">
                                            <i class="bi bi-pencil h3" style="color:#4889CB"></i>
                                        </a>
                                        <span class="icon-spacing"></span>
                                        <a href="#" data-toggle="modal" data-target="#view_type">    
                                            <i class="bi bi-eye h3" style="color:#4889CB"></i>
                                        </a>
                                    </div>
                                </td>
                                </tr>
    ...
    <!-- Add Approval rule -->
            <div id="add_new_approval" class="modal custom-modal fade" role="dialog">
                <form method="POST" action="{{ route('approval.store')}}">
                    @csrf
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Add Approval Rule</h5>
