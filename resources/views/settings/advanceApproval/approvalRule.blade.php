...
<div class="page-wrapper">      
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Advance Approval Rules</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item active">Dashboard/Setting Management/Advance Approval Rule </li>
                    </ul>
                </div>
                @if(session('success'))
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="{{route('advance-approval.create')}}" class="btn add-btn" data-toggle="modal" data-target="#add_advance_approval"><i class="fa fa-plus"></i>Add Advance Approval Rule</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="word-container mb-4">
                            ...
                            <span class="word"><a href="">Expense</a></span>
                            <span class="word active"><a href="">Advance/Loan</a></span>
                            ...
                            <div class="container table-responsive">  
                                ...
                                <td class="text-right"> 
                                    <div class="d-flex align-items-center">
                                        <a href="{{ route('advance-approval.show', ['approvalRule' => $approval->id])}}">
    ...
    <!-- Add Approval rule -->
            <div id="add_advance_approval" class="modal custom-modal fade" role="dialog">
                <form method="POST" action="{{ route('advance-approval.store')}}">
                    @csrf
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Add Advance Approval Rule</h5>
...
<script>
        ...
        function populateTypeDropdown(selectedFor) {
            ...
            if (selectedFor === '') {
                ...
                var options;
            if (selectedFor === 'Loan') {
                options = {!! json_encode($loans->pluck('name', 'id')) !!};
            } else {
