...
@section('content')
    ...
    @if(session('success'))
        ...
        @endif
        <a href="{{ route('advance-approval.create') }}" class="btn btn-primary mb-2">Add New Approval</a>
            ...
            <tbody>
                ...
                @foreach($approvals as $approval)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('advance-approval.show', ['approvalRule' => $approval->id])}}" class="btn btn-primary btn-sm">Edit</a>
