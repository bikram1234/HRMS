        ...
        <div class="row mt-4">
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-12">
                    <form method="POST" action="{{ route('expense-approval.update', $approvalRule->id)}}">
                        @csrf
                        @method('patch')
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    &nbsp;  &nbsp;   &nbsp;
                                    <a href="{{ route('expense-condition.create', ['approval_rule_id' => $approvalRule->id]) }}" class="btn add-btn"><i class="fa fa-plus"></i>Add Condition</a>
                                </div>  
                                    </div>
                            ...
                            <div class="container table-responsive">  
                                ...
                                <td class="text-right"> 
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="{{ route('expense-approval_condition.edit', $approval_condition->id)}}">    
