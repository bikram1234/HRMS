...
<form action="{{ route('fuels.update', $fuel->id) }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-6  mt-3">
            <div class="form-group">
                <strong>Date</strong>
                <input type="date" name="date" value="{{ $fuel->date }}" class="form-control" placeholder="Date">
            </div>
        </div>
        <div class="col-md-6 mt-3">
            <div class="form-group">
        ...
        <div class="col-md-6 mt-3">
            <div class="form-group">
                ...
                <input type="text" name="initial_km" id="initial_km" value="{{ $fuel->initial_km }}" class="form-control" placeholder="Initial KM">
            </div>
        </div>
        <div class="col-md-6 mt-3">
            <div class="form-group">
                <strong>Final KM</strong>
                <input type="text" name="final_km" id="final_km" value="{{ $fuel->final_km }}" class="form-control" placeholder="Final KM">
            </div>
        </div>
        <div class="col-md-6 mt-3">
            <div class="form-group">
                <strong>Qty(ltrs)</strong>
                <input type="text" name="quantity" id="quantity" value="{{ $fuel->quantity }}" class="form-control" placeholder="Quantity" readonly>
            </div>
        </div>
        ...
        <div class="col-md-6 mt-3">
            <div class="form-group">
                <strong>Rate</strong>
                <input type="text" name="rate" id="rate" value="{{ $fuel->rate }}" class="form-control" placeholder="Rate">
            </div>
        </div>
        <div class="col-md-6 mt-3">
            <div class="form-group">
                <strong>Amount</strong>
                <input type="text" name="amount" id="amount" value="{{ $fuel->amount }}" class="form-control" placeholder="Amount" readonly>
            </div>
        </div>
    </div>
