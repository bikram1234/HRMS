                            ...
                            <div class="modal-content">
                                ...
                                <div id="divleavepolicy">
                                 ...
                                 <!-- ========================YEAR END PROCESSING============================================= -->
                                    ...
                                    </label><input type="checkbox" {{ $draftPolicyEnforcement->prevent_submission ? 'checked' : '' }} disabled>Prevent report submission</label>
                                    </div>
                                    <div class="form-group">
                                    </label> <input type="checkbox"  {{ $draftPolicyEnforcement->display_warning ? 'checked' : '' }} disabled> Display warning to user</label>
                                    </div>
                                    </div>
