                    ...
                    <div class="col-md-12">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Edit Policy Enforcement</h5>
                            </div>
                        <div class="modal-body">
                            <div class="card tab-box">
                                ...
                                <div class="row">
                                <label class="mt-3">
                                <input class="form-checkbox" type="checkbox" id="prevent_submission" name="enforcement_options[]" value="prevent_submission" {{ optional($enforcementOptions)->prevent_submission == 1 ? 'checked': ''}} readonly>
                                    <span>Prevent Report Submission</span>
                                </label>
                                    
                                <label class="mt-3">
                                <input class="form-checkbox" type="checkbox" id="display_warning" name="enforcement_options[]" value="display_warning" {{ optional($enforcementOptions)->display_warning == 1 ? 'checked': ''}} readonly>
                                 ...
                                 <div class="modal-footer justify-content-middle mt-3">
                                    ...
                                    &nbsp;  &nbsp;   &nbsp;
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="window.location.href='{{ route('edit-policy-enforcement', ['policy' => $policy->id]) }}'">Cancel</button>
