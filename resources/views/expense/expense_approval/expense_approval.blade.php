            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Expense Approval</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item active">Dashboard/Expense Management/Expense Approval</li>
                            </ul>
                        </div>
                                ...
                                @foreach ($expenseApplications as $key => $expenseApplication)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('expense_details.view', ['id' => $expenseApplication->id]) }}"  type="button"  class="btn btn-danger" data-toggle="modal" data-target="">View</a> 
                                        ...
                                        <div id="declineexpense{{ $expenseApplication->id}}" class="modal custom-modal fade" role="dialog">
                                            <form method="POST" action="{{ route('expense.reject', ['id' => $expenseApplication->id]) }}">
                                            @csrf
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
