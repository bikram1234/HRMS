                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <a href="" class="btn add-btn" data-toggle="modal" data-target="#add_region"><i class="fa fa-plus"></i>Add Region</a>
                            </div>
                    </div>
                </div>
                <!-- /Page Header -->
			...
			<div class="card-body">
                <div class="col-md-12"> 
                    <div class="word-container mb-4">
                        ...
                        <span class="word active"><a href="{{ route('region.index') }}">Region</a></span>
        ...
        <tr>
            ...
            <td class="text-right">
                <div class="d-flex align-items-center">
                    <a href="" data-toggle="modal" data-target="#edit_region{{$region->id}}">
...
<!-- Edit Region-->
<div id="edit_region{{ $region->id }}" class="modal custom-modal fade" role="dialog">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label class="col-form-label">Code<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" id="code" name="code"  value="{{ $region->code }}"required>
                                @error('code')
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label class="col-form-label">Region Name<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" id="name" name="name"  value="{{ $region->name}}"required>
                        @error('name')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
