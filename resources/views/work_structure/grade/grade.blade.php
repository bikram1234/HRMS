                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item active">Dashboard/Work Structure/Grade</li>
                            </ul>
                        </div>

                        <div class="col-auto float-right ml-auto">
						<a href="{{route('grade.create')}}" class="btn add-btn" data-toggle="modal" data-target="#add_grade"><i class="fa fa-plus"></i>Add Grade</a>
						</div> 
    ...
    white-space: nowrap; /* Prevent words from breaking to new lines */
            ...
            <div class="row">
                 <div class="col-md-12 stretch-card">
                            ...
                            <div class="col-md-12">
                                ...
                                @foreach($grades as $key => $grade) 
                                 ...
                                 <th style="width: 30px;">
                                    ...
                                    <a href="{{ route('grade.edit', $grade->id)}}" data-toggle="modal" data-target="#edit_grade{{$grade->id}}">
                    ...
                    <!-- Edit Grade-->
                    <div id="edit_grade{{$grade->id}}" class="modal custom-modal fade" role="dialog">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label">Grade Name<span class="text-danger">*</span></label>
                                                        <input class="form-control" type="text" id="name" name="name" value="{{ old('name', $grade->name) }}">
                                                            @error('name')
